...
var BigInt = RSAUtils.BigInt = function (flag) {
...
if (typeof RSAUtils.twoDigit === 'undefined') {
...
getEncryptedString = function (encryptionExponent, decryptionExponent, modulus, r) {
    return RSAUtils.encryptedString(RSAUtils.getKeyPair(encryptionExponent, decryptionExponent, modulus), r)
